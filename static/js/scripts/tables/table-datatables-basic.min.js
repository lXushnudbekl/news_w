$((function () {
    "use strict";
    var e = $(".datatables-basic"), t = $(".dt-date"), a = $(".dt-complex-header"), s = $(".dt-row-grouping"),
        l = $(".dt-multilingual"), o = "../../../app-assets/";
    ...
    if (s.length) {
        var d = s.DataTable({
            ...
            columnDefs: [{className: "control", orderable: !1, targets: 0}, {visible: !1, targets: 2}, {
                targets: -2,
                render: function (e, t, a, s) {
                    var l = a.status, o = {
                        1: {title: "Current", class: "badge-light-primary"},
