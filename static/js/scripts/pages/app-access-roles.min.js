$((function () {
    var e = $(".user-list-table"), t = "static", a = "app-user-view-account.html", s = {
        1: {title: "Pending", class: "badge-light-warning"},
        2: {title: "Active", class: "badge-light-success"},
        3: {title: "Inactive", class: "badge-light-secondary"}
    };
    "laravel" === $("body").attr("data-framework") && (t = $("body").attr("data-asset-path"), a = t + "app/user/view/account"), e.length && e.DataTable({
        ajax: t + "data/user-list.json",
        columns: [{data: ""}, {data: "id"}, {data: "full_name"}, {data: "role"}, {data: "current_plan"}, {data: "billing"}, {data: "status"}, {data: ""}],
        columnDefs: [{
            className: "control",
            orderable: !1,
            ...
            targets: 2, responsivePriority: 4, render: function (e, s, n, l) {
                var r = n.full_name, c = n.email, o = n.avatar;
                if (o) var i = '<img src="' + t + "images/avatars/" + o + '" alt="Avatar" height="32" width="32">'; else {
                    var d = ["success", "danger", "warning", "info", "dark", "primary", "secondary"][Math.floor(6 * Math.random()) + 1],
                        u = (r = n.full_name).match(/\b\w/g) || [];
                    i = '<span class="avatar-content">' + (u = ((u.shift() || "") + (u.pop() || "")).toUpperCase()) + "</span>"
                }
                return '<div class="d-flex justify-content-left align-items-center"><div class="avatar-wrapper"><div class="avatar ' + ("" === o ? " bg-light-" + d + " " : "") + ' me-1">' + i + '</div></div><div class="d-flex flex-column"><a href="' + a + '" class="user_name text-body text-truncate"><span class="fw-bolder">' + r + '</span></a><small class="emp_post text-muted">' + c + "</small></div></div>"
            }
        }, {
            targets: 3, render: function (e, t, a, s) {
                var n = a.role;
                return "<span class='text-truncate align-middle'>" + {
            ...
            targets: 5, render: function (e, t, a, s) {
                return '<span class="text-nowrap">' + a.billing + "</span>"
            }
        }, {
            targets: 6, render: function (e, t, a, n) {
                var l = a.status;
                return '<span class="badge rounded-pill ' + s[l].class + '" text-capitalized>' + s[l].title + "</span>"
            }
        }, {
            targets: -1, title: "Actions", orderable: !1, render: function (e, t, s, n) {
                return '<a href="' + a + '" class="btn btn-sm btn-icon">' + feather.icons.eye.toSvg({class: "font-medium-3 text-body"}) + "</a>"
            }
        }],
        order: [[2, "desc"]],
